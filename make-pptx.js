...
const weekKeys = ['semana-1', 'semana-2', 'semana-3', 'semana-4'];
...
weekKeys.forEach(weekKey => {
  ...
  dayKeys.forEach(dayKey => {
    ...
    day.slides.forEach((slide, slideIndex) => {
      ...
      const footerText = `MÓDULO 1: FUNDAMENTOS DEL DISEÑO • ${dayKey.toUpperCase()}: ${day.title ? day.title.split(': ')[1] : ''}`;
      ...
      if (slide.layout === 'title') {
        ...
        if (isQuestion) {
          ...
          pptxSlide.addText(`MÓDULO 1 • CLASE ${classCounter} (45 MIN)`, {
            x: 3.5,
            y: pillY,
            w: 5.6,
            h: 0.6,
...
const desktopPptxFile = 'C:/Users/alond/OneDrive/Escritorio/presentacion-modulo-1.pptx';
pptx.writeFile({ fileName: desktopPptxFile })
  .then(fileName => {
    ...
    try {
      const srcZip = 'C:/Users/alond/.gemini/antigravity/brain/9621502e-b2fa-4f18-908b-471b6d8f727d/modulo-1-presentaciones.zip';
      const destZip = 'C:/Users/alond/OneDrive/Escritorio/modulo-1-presentaciones.zip';
